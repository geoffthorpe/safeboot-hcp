...
declare -A hcp_entity=( \
	...
	[kdc_primary_pol]=/usecase/kdc_primary.pol.env \
	[kdc_secondary]=/usecase/kdc_secondary.env \
	[kdc_secondary_tpm]=/usecase/kdc_secondary_tpm.env \
	[kdc_secondary_pol]=/usecase/kdc_secondary.pol.env \
	[sherver]=/usecase/sherver.env \
	[sherver_tpm]=/usecase/sherver_tpm.env \
	[caboodle_networked]=/usecase/caboodle_networked.env \
	[caboodle_networked_tpm]=/usecase/caboodle_networked_tpm.env \
	...
	[wait_sherver]=/usecase/sherver.env \
	[wait_caboodle_networked]=/usecase/caboodle_networked.env \
...
declare -A hcp_entity_type=( \
	...
	[sherver]=service \
	[sherver_tpm]=service \
	[caboodle_networked]=service \
	[caboodle_networked_tpm]=service \
	[aclient_tpm]=service \
	[aclient]=util \
...
declare -A hcp_entity_cmd=( \
	...
	[sherver]=/hcp/sshsvc/run_sshsvc.sh \
	[sherver_tpm]=/hcp/swtpmsvc/run_swtpm.sh \
	[caboodle_networked]=/hcp/common/do_nothing.sh \
	[caboodle_networked_tpm]=/hcp/swtpmsvc/run_swtpm.sh \
	...
	[wait_sherver]="/hcp/sshsvc/healthcheck.sh -R 9999" \
	[wait_caboodle_networked]="/hcp/caboodle/networked_healthcheck.sh -R 9999" \
